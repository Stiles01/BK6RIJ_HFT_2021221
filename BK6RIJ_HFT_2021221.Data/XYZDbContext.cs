    ...
    public class XYZDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            List<Order> orders = new List<Order>()
            {
                ...
                new Order { OrderId = 1, CustomerId = 4, ProductId = 4, DeliveryId = 3, OrderDate = new DateTime(2020, 10, 14) },
                new Order { OrderId = 2, CustomerId = 2, ProductId = 5, DeliveryId = 2, OrderDate = new DateTime(2020, 07, 26) },
                new Order { OrderId = 3, CustomerId = 2, ProductId = 3, DeliveryId = 4, OrderDate = new DateTime(2020, 07, 16) },
                new Order { OrderId = 4, CustomerId = 3, ProductId = 6, DeliveryId = 1, OrderDate = new DateTime(2020, 03, 04) },
                new Order { OrderId = 5, CustomerId = 1, ProductId = 1, DeliveryId = 2, OrderDate = new DateTime(2020, 09, 30) },
                new Order { OrderId = 6, CustomerId = 4, ProductId = 4, DeliveryId = 3, OrderDate = new DateTime(2020, 10, 30) },
                new Order { OrderId = 7, CustomerId = 3, ProductId = 3, DeliveryId = 1, OrderDate = new DateTime(2020, 11, 30) },
                new Order { OrderId = 8, CustomerId = 2, ProductId = 5, DeliveryId = 2, OrderDate = new DateTime(2020, 08, 30) },
                new Order { OrderId = 9, CustomerId = 1, ProductId = 2, DeliveryId = 1, OrderDate = new DateTime(2020, 07, 30) },
                new Order { OrderId = 10, CustomerId = 1, ProductId = 1, DeliveryId = 2, OrderDate = new DateTime(2020, 06, 30) },
            };
